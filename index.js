...
document.getElementById('predictButton').addEventListener('click', () => {
    ...
    document.getElementById('output').innerText = model.predict(tf.tensor2d([value], [1, 1]));
})

// document.getElementById('predictButton').addEventListener('click', (el, ev) => {
//     let val = document.getElementById('inputValue').value;
//     document.getElementById('output').innerHTML = model.predict(tf.tensor2d([val], [1, 1]));
// })
